...
## TX 0 : 7 = 4 + 4 (0-6/7-13: 0-3)
	netperf -H $dip1 -t TCP_MAERTS -l $TIME -T 1,0 -P 0 -- -m1M > /dev/null &
	netperf -H $dip1 -t TCP_MAERTS -l $TIME -T 3,1 -P 0 -- -m1M > /dev/null &
	netperf -H $dip1 -t TCP_MAERTS -l $TIME -T 5,2 -P 0 -- -m1M > /dev/null &
...
## TX 1 : 7 = 4 + 4 (14-20/21-27: 8-11)
	netperf -H $dip1 -t TCP_MAERTS -l $TIME -T 19,8 -P 0 -- -m1M > /dev/null &
	netperf -H $dip1 -t TCP_MAERTS -l $TIME -T 21,9 -P 0 -- -m1M > /dev/null &
	netperf -H $dip1 -t TCP_MAERTS -l $TIME -T 23,10 -P 0 -- -m1M > /dev/null &
