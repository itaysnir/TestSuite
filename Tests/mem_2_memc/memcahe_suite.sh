...
function set_memcached {
	...
	LOCAL=$1
		...
		let mport++
		taskset -c 1 memcached -l $LOCAL:$mport -m 1024 -d -t 1 -I 1M
		let mport++
		taskset -c 2 memcached -l $LOCAL:$mport -m 1024 -d -t 1 -I 1M
		let mport++
		taskset -c 3 memcached -l $LOCAL:$mport -m 1024 -d -t 1 -I 1M
		let mport++
		taskset -c 4 memcached -l $LOCAL:$mport -m 1024 -d -t 1 -I 1M
		let mport++
		taskset -c 5 memcached -l $LOCAL:$mport -m 1024 -d -t 1 -I 1M
		let mport++
		taskset -c 6 memcached -l $LOCAL:$mport -m 1024 -d -t 1 -I 1M
		let mport++
		taskset -c 7 memcached -l $LOCAL:$mport -m 1024 -d -t 1 -I 1M
		let mport++
}
