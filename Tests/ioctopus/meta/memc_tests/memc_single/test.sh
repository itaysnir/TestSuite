...
numactl  --membind=$core --physcpubind=$core memcached -l $ip2:11211 -m 32768 -d -t 1
#`pwd`/memcahe_suite.sh memcached $ip2 11211
ssh $loader1 TIME=$TIME /tmp/memcahe_suite.sh single $ip2 11211 |tee -a $OUT_FILE/memc.txt & #|`pwd`/sum_memc.pl
